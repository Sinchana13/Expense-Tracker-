...
if (isset($_POST['searchbtn'])) {
	...
	$GetIncomeHistory = "SELECT * from assets left join category on assets.CategoryId = category.CategoryId left join account on assets.AccountId = account.AccountId where 
                    ...
                    OR assets.Month like '%$SearchTerm%'
...
if (isset($_POST['searchbtn'])) {
    ...
    // Extract the month from the search term (e.g., Nov)
    $searchDate = DateTime::createFromFormat('M', $SearchTerm);
    if ($searchDate !== false) {
        $monthCondition = "AND MONTH(assets.Date) = " . $searchDate->format('m');
    } else {
        $monthCondition = "";
    }
    
    $GetIncomeHistory = "SELECT * FROM assets
                            ...
                            <div class="">
                                <table class="table table-bordered table-hover table-striped" id="assetsdata">
        			                ...
        			                <tr>
                                        ...
                                        <th class="text-left"><?php echo $Month; ?></th>
