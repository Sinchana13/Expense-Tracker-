...
<head>
    ...
    <style>
        body {
        background-image: url('https://i.pinimg.com/564x/0f/15/41/0f154107874a2a71be62eb2b1e446aee.jpg');
...
$RegisterAnAccount; ?></a>
        ...
        <div class="row text-center">
            <small style="color:white"> <?php echo Date('Y'); ?> Billion Dollar Expense Tracker </small><br>
            <small style="color:white">Powered By Sinchana and Shravani</small>
        </div>
    </div>
